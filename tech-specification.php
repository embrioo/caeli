                                            ...
                                            <div class="tech-info-box">
                                                ...
                                                <div class="row mobile-padding">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <p class="row row-spec"><span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-f800_prop18_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-f800_prop18_val'] ?></span></p>
                                                        <p class="row row-spec">
											...
											<div class="tech-info-box">
                                                ...
                                                <div class="row mobile-padding">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <p class="row row-spec"><span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-f1100_prop18_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-f1100_prop18_val'] ?></span></p>
                                                        <p class="row row-spec">
