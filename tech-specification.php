											...
											<div class="tech-info-box">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 mobile-padding">
                                                        ...
                                                        <p class="row row-spec"><span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-f1500_prop18_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-f1500_prop18_val'] ?>&nbsp;<span class="inner-span"><?php echo $current_lang['specification-f1500_prop18_val_inner'] ?></span></span></p>
                                                        <p class="row row-spec">
