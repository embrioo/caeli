					...
					<div class="row">
						<div class="col-lg-10 col-lg-offset-1">
							...
							<ul class="list-unstyled">
								...
								<li><a href="/tech-description.php"><?php echo $current_lang['innovative-text-3'] ?></a></li>
                                <li><a class="bigger-margin-bottom" href="/tech-specification.php?caeli=spec2"><?php echo $current_lang['innovative-text-2'] ?></a></li>
								<li><a href="#"><?php echo $current_lang['innovative-text-4'] ?></a></li>
							</ul>
<!--                            <div class="round-image-box"><img class="avatar" src="./images/filter.png" alt=""></div>-->
