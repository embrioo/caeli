	...
	<section class="page-banner banner">
		<div class="container-fluid">
			<div class="box">
				...
				<h4 class="text-capitalize"><?php echo $current_lang['specification-f1100_desc'] ?></h4>
			</div>
		</div>
	</section>
                                        ...
                                        <div class="tech-info-box">
                                            ...
                                            <div class="row mobile-padding">
                                                <div class="col-sm-12">
                                                    ...
                                                    <p class="row row-spec">
                                                        <span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4 dark-color text-shrink"><?php echo $current_lang['specification-f800_prop4_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8 dark-color"><?php echo $current_lang['specification-f1100_prop4_val'] ?></span>
                                                        ...
                                                        <span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-f1100_prop6_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-f1100_prop6_val'] ?></span>
                                                    </p>
                                                    ...
                                                    <p class="row row-spec">
                                                        <span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-f1100_prop9_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-sa-f1100_prop9_val'] ?></span>
                                                        ...
                                                        <span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-sa-f1100_prop11_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-sa-f1100_prop11_val'] ?></span>
                                                        <span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-sa-f1100_prop11_2_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-sa-f1100_prop11_2_val'] ?></span>
                                                    </p>
                                                    <p class="row row-spec">
                                                        <span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-f1100_prop12_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-sa-f1100_prop12_val'] ?></span>
                                                        <span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-f1100_prop13_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-sa-f1100_prop13_val'] ?></span>
                                                    ...
                                                    <p class="row row-spec"><span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-f1100_prop18_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-f1100_prop18_val'] ?>&nbsp;<span class="inner-span"><?php echo $current_lang['specification-f1100_prop18_val_inner'] ?></span></span></p>
                                                    <p class="row row-spec">
                                                        ...
                                                        <span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-f1100_prop20_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-sa-f1100_prop20_val'] ?></span>
                                                    </p>
