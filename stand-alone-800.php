...
<!--                              <p class="final-text"><?php echo $current_lang['order-now-text-5'] ?><span><?php echo $current_lang['order-now-text-6'] ?></span></p>-->
                        ...
                        <ul class="nav nav-tabs nav-default">
                            <li class="active"><a class="tab-spec1" data-toggle="tab" href="tech-specification.php?caeli=spec1"><?php echo $current_lang['specification-btn_f800'] ?></a></li>
                            <li><a class="tab-spec2" data-toggle="tab" href="tech-specification.php?caeli=spec2" ><?php echo $current_lang['specification-btn_f1100'] ?></a></li>
