				...
				<div class="col-lg-10 col-lg-offset-1">
					<div class="row">
								...
								<div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="tech-info-box">
                                            <h2><?php echo $current_lang['specification-sa-f800_name'] ?></h2>
                                            <p class="sub-label text-uppercase orange-colored"><?php echo $current_lang['specification-f800_desc'] ?></p>
                                            <p class="margin-bottom"><?php echo $current_lang['specification-sa-f800_subs'] ?></p>
                                            <div class="row mobile-padding">
                                                <div class="col-sm-12">
                                                    ...
                                                    <p class="row row-spec">
                                                        <span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-f800_prop9_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-sa-f800_prop9_val'] ?></span>
                                                    ...
                                                    <p class="row row-spec">
                                                        ...
                                                        <span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-f800_prop13_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-sa-f800_prop13_val'] ?></span>
                                                    ...
                                                    <p class="row row-spec">
                                                        ...
                                                        <span class="spec-title col-xs-5 col-xs-offset-1 col-sm-5 col-sm-offset-0 col-md-4"><?php echo $current_lang['specification-f800_prop20_lbl'] ?></span><span class="spec-value col-xs-6 col-sm-7 col-md-8"><?php echo $current_lang['specification-sa-f800_prop20_val'] ?></span>
                                                    </p>
                        ...
                        <ul class="nav nav-tabs nav-default">
                            <li class="active"><a class="tab-spec1" href="/tech-specification.php?caeli=spec1"><?php echo $current_lang['specification-btn_f800'] ?></a></li>
                            <li><a class="tab-spec2" href="/tech-specification.php?caeli=spec2" ><?php echo $current_lang['specification-btn_f1100'] ?></a></li>
